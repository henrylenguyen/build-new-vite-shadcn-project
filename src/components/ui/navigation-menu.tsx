...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Root
    ref={ref}
    className={cn('yrelative yz-10 yflex ymax-w-max yflex-1 yitems-center yjustify-center', className)}
    {...props}
  >
    {children}
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.List
    ref={ref}
    className={cn('ygroup yflex yflex-1 ylist-none yitems-center yjustify-center yspace-x-1', className)}
    {...props}
  />
))
